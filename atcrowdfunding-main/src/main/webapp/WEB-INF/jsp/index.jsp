...
<body>
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                <img class="img-circle" src="${PATH}/static/img/p1.jpg" alt="Generic placeholder image"
            ...
            <div class="col-lg-4">
                <img class="img-circle" src="${PATH}/static/img/p2.jpg" alt="Generic placeholder image"
                     style="width: 140px; height: 140px;">
                <h2>NEOKA智能手环</h2>
            ...
            <div class="col-lg-4">
                <img class="img-circle" src="${PATH}/static/img/p3.png" alt="Generic placeholder image"
                     style="width: 140px; height: 140px;">
                <h2>驱蚊扣</h2>
